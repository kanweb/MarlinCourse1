                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="example-select">
                                            <option <?if($user['status']=="Онлайн") echo "selected"?>>Онлайн</option>
                                            <option <?if($user['status']=="Отошел") echo "selected"?>>Отошел</option>
                                            <option <?if($user['status']=="Не беспокоить") echo "selected"?>>Не беспокоить</option>
                                        </select>
                                    </div>
                                </div>
